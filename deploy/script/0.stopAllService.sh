...
docker compose -f /srv/deploy/nginx-config/deploy/dockwatch/docker-compose.yml down 
...
docker compose -f /srv/deploy/nginx-config/deploy/ray-auto-deploy-server/docker-compose.yml down 
